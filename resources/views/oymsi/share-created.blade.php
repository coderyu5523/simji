...
--}}
<x-layouts.app title="공유 링크가 만들어졌어">
  <div class="bg-cream min-h-[70vh]">
    <div class="max-w-md mx-auto px-4 py-12">

      <h1 class="text-2xl font-extrabold text-deepgreen">공유 링크가 만들어졌어</h1>
      <p class="mt-3 text-sm text-navy/70">
        이 링크를 보호자에게 보내면 결과를 볼 수 있어.
        링크를 아는 사람은 로그인 없이 열 수 있으니 보호자에게만 보내 줘.
      </p>
      ...
      <div class="mt-6 rounded-2xl bg-white p-4 ring-1 ring-black/5">
        ...
        <p id="copy-done" class="mt-2 hidden text-center text-xs text-teal">복사했어</p>
      </div>

      <p class="mt-4 text-sm text-navy/60">
        {{ $expiresAt->format('Y년 n월 j일') }}까지 열려 있어. 그 뒤에는 링크가 저절로 닫혀.
      </p>
