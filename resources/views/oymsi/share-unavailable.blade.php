...
@php
  $copy = [
    'not_scored' => [
      ...
      'body' => '검사를 끝까지 마치면 결과가 만들어집니다. 결과가 나온 다음에 보호자와 공유할 수 있습니다.',
    ],
    'result_hidden' => [
      'title' => '지금은 결과를 공유할 수 없습니다',
      'body' => '검사를 발급한 곳에서 결과 공개를 준비하고 있습니다. 공개되면 그때 보호자와 공유할 수 있습니다.',
    ],
    // 가족·보호환경(FAM) 빨강 — 보호자 공유 차단. ShareController::familyRiskBlocksShare() 참조.
    // 차단 사실을 숨기지 않고 이유와 대안을 같이 준다(조용한 폴백 금지).
    'family_risk' => [
      'title' => '이 결과는 상담자와 먼저 이야기해 보세요',
      'body' => '가족·보호환경 영역에서 힘든 신호가 크게 나타났습니다. 그래서 지금은 보호자와 결과를 바로 나누는 링크를 만들지 않습니다. '
              . '먼저 상담자와 이야기하면서 누구에게 어떻게 알릴지 함께 정하는 것이 안전합니다. '
              . '1388은 전화·문자·온라인 모두 가능하고, 가족 문제도 상담할 수 있습니다.',
    ],
  ][$reason];
@endphp

<x-layouts.app title="공유할 수 없습니다">
  <div class="bg-cream min-h-[70vh]">
    <div class="max-w-lg mx-auto px-4 py-16">
      ...
      <div class="mt-6 rounded-2xl bg-deepgreen/5 p-5 ring-1 ring-deepgreen/10">
        <p class="text-sm text-navy/70">지금 이야기하고 싶은 것이 있으면 여기로 연락하세요.</p>
